    ...
    <div>
      <div class="brand-logo d-flex align-items-center justify-content-between">
        <a href="{{ route('dashboard.index') }}" class="text-nowrap logo-img">
          <img src="{{ asset('assets/images/logofix_transparent.png') }}" class="dark-logo" width="180" alt="" />
          <img src="{{ asset('assets/images/logofix_transparent.png') }}" class="light-logo" width="180" alt="" />
        </a>
